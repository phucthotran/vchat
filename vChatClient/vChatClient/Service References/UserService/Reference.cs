...
namespace vChat.UserService {
    ...
    public partial class MethodInvokeResult : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private vChat.UserService.ExceptionInfo ExceptionField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string MessageField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private vChat.UserService.MethodInvokeResult.RESULT StatusField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public vChat.UserService.ExceptionInfo Exception {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public vChat.UserService.MethodInvokeResult.RESULT Status {
            get {
    ...
    public partial class Conversation : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private vChat.UserService.Users SendToField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private vChat.UserService.Users SentByField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public vChat.UserService.Users SendTo {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public vChat.UserService.Users SentBy {
            get {
    ...
    public interface IUserService {
        ...
        vChat.UserService.Users Info(int UserID);
        ...
        vChat.UserService.Users[] FriendList(int UserID);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IUserService/Login", ReplyAction="http://tempuri.org/IUserService/LoginResponse")]
        vChat.UserService.MethodInvokeResult Login(string Username, string Password);
        ...
        vChat.UserService.MethodInvokeResult Signup(string Username, string Password, string FirstName, string LastName, int QuestionID, string Answer, System.DateTime Birthdate);
        ...
        vChat.UserService.MethodInvokeResult UserExist(string Username);
        ...
        vChat.UserService.MethodInvokeResult ChangePassword(int UserID, string OldPassword, string NewPassword);
        ...
        vChat.UserService.MethodInvokeResult Deactive(int UserID);
        ...
        vChat.UserService.MethodInvokeResult Reactive(int UserID);
        ...
        vChat.UserService.Conversation[] GetConversations(int UserID);
        ...
        vChat.UserService.Conversation[] GetNewestConversations(int UserID);
        ...
        vChat.UserService.Conversation[] ListSer(int ID);
    }
    ...
    public partial class UserServiceClient : System.ServiceModel.ClientBase<vChat.UserService.IUserService>, vChat.UserService.IUserService {
        ...
        public vChat.UserService.Users Info(int UserID) {
            return base.Channel.Info(UserID);
        }
        
        public vChat.UserService.Users[] FriendList(int UserID) {
            return base.Channel.FriendList(UserID);
        }
        
        public vChat.UserService.MethodInvokeResult Login(string Username, string Password) {
            return base.Channel.Login(Username, Password);
        }
        
        public vChat.UserService.MethodInvokeResult Signup(string Username, string Password, string FirstName, string LastName, int QuestionID, string Answer, System.DateTime Birthdate) {
            return base.Channel.Signup(Username, Password, FirstName, LastName, QuestionID, Answer, Birthdate);
        }
        
        public vChat.UserService.MethodInvokeResult UserExist(string Username) {
            return base.Channel.UserExist(Username);
        }
        
        public vChat.UserService.MethodInvokeResult ChangePassword(int UserID, string OldPassword, string NewPassword) {
            return base.Channel.ChangePassword(UserID, OldPassword, NewPassword);
        }
        
        public vChat.UserService.MethodInvokeResult Deactive(int UserID) {
            return base.Channel.Deactive(UserID);
        }
        
        public vChat.UserService.MethodInvokeResult Reactive(int UserID) {
            return base.Channel.Reactive(UserID);
        }
        
        public vChat.UserService.Conversation[] GetConversations(int UserID) {
            return base.Channel.GetConversations(UserID);
        }
        
        public vChat.UserService.Conversation[] GetNewestConversations(int UserID) {
            return base.Channel.GetNewestConversations(UserID);
        }
        
        public vChat.UserService.Conversation[] ListSer(int ID) {
